...
const TEST_STORAGE_ID = 'listening_test_32';
...
function restoreSavedAnswers() {
    ...
    updateProgress();
            ...
            const audioSequence = [
                "TEST 32 section 1.mp3",
                "TEST 32 section 2.mp3",
                "TEST 32 section 3.mp3",
                "TEST 32 section 4.mp3"
            ];
            ...
            correctAnswers[1] = 'light';
            correctAnswers[2] = 'manager';
            correctAnswers[3] = 'automatic';
            correctAnswers[4] = 'tires|tyres';
            correctAnswers[5] = '8';
            correctAnswers[6] = 'station';
            correctAnswers[7] = 'thursday';
            correctAnswers[8] = 'gerald';
            correctAnswers[9] = 'supermarket';
            correctAnswers[10] = 'identification';
            correctAnswers[11] = 'B';
            correctAnswers[12] = 'A';
            correctAnswers[13] = 'C';
            correctAnswers[14] = 'A';
            ...
            correctAnswers[29] = 'E';
            correctAnswers[30] = 'B';
            correctAnswers[31] = 'marketing';
            correctAnswers[32] = 'airlines';
            correctAnswers[33] = 'feedback';
            correctAnswers[34] = 'behavior|behaviour';
            correctAnswers[35] = 'pilots';
            correctAnswers[36] = 'exercise';
            correctAnswers[37] = 'piano';
            correctAnswers[38] = 'hand';
            correctAnswers[39] = 'fun';
            correctAnswers[40] = 'privacy';
            ...
            const testData = [
                {
                    title: "SECTION 1",
                    instructions: "Questions 1-10: Second-hand Cars",
                    description: "Complete the notes. ONE WORD AND/OR A NUMBER for each answer.",
                    questionRange: "1-10"
                },
                {
                    title: "SECTION 2",
                    instructions: "Questions 11-20: The Middletown Urban Farming Scheme (MUFS)",
                    description: "Q11-16 multiple choice and Q17-20 matching free goods/services.",
                    questionRange: "11-20"
                },
                {
                    title: "SECTION 3",
                    instructions: "Questions 21-30: Research on the effect of walking on creativity",
                    description: "Q21-26 multiple choice and Q27-30 matching physical benefits.",
                    questionRange: "21-30"
                },
                {
                    title: "SECTION 4",
                    instructions: "Questions 31-40: Gamification",
                    description: "Complete the notes below. ONE WORD ONLY for each answer.",
                    questionRange: "31-40"
                }
            ];
            const partRanges = [
            ...
            const radioQuestionIds = [11, 12, 13, 14, 15, 16, 21, 22, 23, 24, 25, 26];
            const multiSelectQuestionIds = [];
            const dropZoneQuestionIds = [17, 18, 19, 20, 27, 28, 29, 30];
