        ...
        const TEST_STORAGE_ID = 'reading_reading_passage_2s_passage_2_22';
        const TEST_LABEL = 'Passage 2.22';
...
function normalizeSummaryGroups() {
    document.querySelectorAll('.question-group').forEach(group => {
        ...
        const groupedChoiceConfigs = [
            { name: 'q19_20_choice', qStart: 19, qEnd: 20, reviewId: 'q19-20-review' },
        ...
        setupPairedMultiSelect('q19_20_choice', 'q19', 'q20');
