...
const TEST_STORAGE_ID = 'listening_test_21';
...
function restoreSavedAnswers() {
    ...
    updateProgress();
            ...
            correctAnswers[29] = 'E';
            correctAnswers[30] = 'C';
            correctAnswers[31] = 'jokes';
            correctAnswers[32] = 'groups';
            correctAnswers[33] = 'parents';
            correctAnswers[34] = 'action';
            correctAnswers[35] = 'adults';
            correctAnswers[36] = 'creative';
            correctAnswers[37] = 'gender';
            correctAnswers[38] = 'difference';
            correctAnswers[39] = 'pictures';
            correctAnswers[40] = 'danger';
            ...
            const testData = [
                {
                    ...
                    description: "Complete the holiday rental notes. ONE WORD AND/OR A NUMBER.",
                    questionRange: "1-10"
                },
                {
                    title: "SECTION 2",
                    instructions: "Questions 11-20: Working for Johnson Jones",
                    description: "Q11-15 multiple choice and Q16-20 matching.",
                    questionRange: "11-20"
                },
                {
                    title: "SECTION 3",
                    instructions: "Questions 21-30: The effect of music",
                    description: "Q21-24 multiple choice, Q25-26 choose two, and Q27-30 matching.",
                    questionRange: "21-30"
                },
                {
                    title: "SECTION 4",
                    instructions: "Questions 31-40: Research on children humour",
            ...
            const radioQuestionIds = [11, 12, 13, 14, 15, 21, 22, 23, 24];
            const multiSelectQuestionIds = [25, 26];
            const dropZoneQuestionIds = [16, 17, 18, 19, 20, 27, 28, 29, 30];

            const multiGroupMap = { 25: "q25_26", 26: "q25_26" };
