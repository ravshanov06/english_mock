...
const TEST_STORAGE_ID = 'listening_test_40';
...
function restoreSavedAnswers() {
    ...
    updateProgress();
            ...
            correctAnswers[1] = '18th July|18 July';
            correctAnswers[2] = 'GT1632';
            correctAnswers[3] = 'photographs';
            correctAnswers[4] = 'Poskitt';
            correctAnswers[5] = 'Way';
            correctAnswers[6] = 'engineer';
            correctAnswers[7] = 'fish';
            correctAnswers[8] = 'blues';
            correctAnswers[9] = 'magazine';
            correctAnswers[10] = 'parking';
            correctAnswers[11] = 'C';
            correctAnswers[12] = 'D';
            correctAnswers[13] = 'F';
            correctAnswers[14] = 'B';
            ...
            correctAnswers[19] = 'A';
            correctAnswers[20] = 'B';
            correctAnswers[21] = 'Professional Learning';
            correctAnswers[22] = 'team';
            correctAnswers[23] = 'presenting results';
            correctAnswers[24] = 'behaviour|behavior';
            correctAnswers[25] = 'diary';
            correctAnswers[26] = 'video recording';
            correctAnswers[27] = 'simulation';
            correctAnswers[28] = 'test results';
            correctAnswers[29] = 'internet';
            correctAnswers[30] = 'interviews';
            correctAnswers[31] = 'A';
            correctAnswers[32] = 'B';
            correctAnswers[33] = 'B';
            correctAnswers[34] = 'B';
            ...
            const testData = [
                {
                    ...
                    description: "Complete the form. ONE WORD AND/OR A NUMBER.",
                    questionRange: "1-10"
                },
                {
                    title: "SECTION 2",
                    instructions: "Listen and answer questions 11-20.",
                    description: "Q11-15 matching and Q16-20 multiple choice.",
                    questionRange: "11-20"
                },
                {
                    title: "SECTION 3",
                    instructions: "Listen and answer questions 21-30.",
                    description: "Complete the notes and tables. NO MORE THAN TWO WORDS.",
                    questionRange: "21-30"
                },
                {
                    title: "SECTION 4",
                    instructions: "Listen and answer questions 31-40.",
                    description: "Q31-33 multiple choice and Q34-40 matching.",
                    questionRange: "31-40"
                }
            ];
            const partRanges = [
