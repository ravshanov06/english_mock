        ...
        const TEST_STORAGE_ID = 'reading_reading_passage_2s_passage_2_32';
        const TEST_LABEL = 'Passage 2.32';
...
function normalizeSummaryGroups() {
    document.querySelectorAll('.question-group').forEach(group => {
        ...
        const groupedChoiceConfigs = [
            ...
            { name: 'q22_23_choice', qStart: 22, qEnd: 23, reviewId: 'q22-23-review' },
        ];
        ...
        setupPairedMultiSelect('q22_23_choice', 'q22', 'q23');
