...
const TEST_STORAGE_ID = 'listening_test_26';
...
function restoreDropZoneAnswer(questionId, answerValue) {
    ...
    const answer = String(answerValue).toUpperCase();
    const optionPrefix = questionId >= 25 ? 'opt25' : questionId >= 7 && questionId <= 10 ? 'opt7' : 'opt11';
    const item = Array.from(document.querySelectorAll('.drag-item')).find((node) =>
        (node.dataset.option || '').startsWith(optionPrefix) &&
        (node.dataset.answer || node.dataset.option || '').toUpperCase() === answer
    );
    if (!item) return;
...
function restoreSavedAnswers() {
    ...
    updateProgress();
            ...
            correctAnswers[2] = 'E';
            correctAnswers[3] = 'F';
            correctAnswers[4] = 'eight|8';
            correctAnswers[5] = 'clean';
            correctAnswers[6] = 'signs';
            correctAnswers[7] = 'C';
            correctAnswers[8] = 'B';
            correctAnswers[9] = 'A';
            correctAnswers[10] = 'C';
            ...
            correctAnswers[17] = 'A';
            correctAnswers[18] = 'C';
            correctAnswers[19] = 'information desk';
            correctAnswers[20] = 'lockers';
            correctAnswers[21] = 'C';
            correctAnswers[22] = 'B';
            correctAnswers[23] = 'C';
            correctAnswers[24] = 'A';
            ...
            correctAnswers[29] = 'A';
            correctAnswers[30] = 'B';
            correctAnswers[31] = 'teenagers';
            correctAnswers[32] = 'similar';
            correctAnswers[33] = 'income';
            correctAnswers[34] = 'surveys';
            correctAnswers[35] = 'drink milk';
            correctAnswers[36] = 'time';
            correctAnswers[37] = 'number';
            correctAnswers[38] = 'relationship';
            correctAnswers[39] = 'age';
            correctAnswers[40] = 'friends';
            ...
            const testData = [
                {
                    title: "PART 1",
                    instructions: "Questions 1-10: Electronics store plan and DVD categories",
                    description: "Q1-3 map labelling, Q4-6 notes, and Q7-10 DVD category decisions.",
                    questionRange: "1-10"
                },
                {
                    title: "PART 2",
                    instructions: "Questions 11-20: The Heritage Clothes exhibition",
                    description: "Q11-18 multiple choice and Q19-20 sentence completion.",
                    questionRange: "11-20"
                },
                {
                    title: "PART 3",
                    instructions: "Questions 21-30: Pacific tapa cloth",
                    description: "Q21-24 multiple choice and Q25-30 drag-and-drop matching.",
                    questionRange: "21-30"
                },
                {
                    title: "PART 4",
                    instructions: "Questions 31-40: The Influence of Children on Adult Diet",
            ...
            const radioQuestionIds = [1, 2, 3, 11, 12, 13, 14, 15, 16, 17, 18, 21, 22, 23, 24];
            const multiSelectQuestionIds = [];
            const dropZoneQuestionIds = [7, 8, 9, 10, 25, 26, 27, 28, 29, 30];
            ...
            function setupDragDrop() {
                ...
                zones.forEach(zone => {
                    ...
                    zone.addEventListener('drop', (e) => {
                        ...
                        if (!isMultiple) {
                            zone.draggable = true;
                            const sourceMultiple = e.dataTransfer.getData('text/multiple') === 'true';
                            const item = document.querySelector(`.drag-item[data-option="${optionId}"]`);
                            if (item && !sourceMultiple && !sourceZone) {
                                item.dataset.used = "true";
                                item.classList.add('used');
                                item.draggable = false;
                            }
