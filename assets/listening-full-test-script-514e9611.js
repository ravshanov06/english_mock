...
const TEST_STORAGE_ID = 'listening_test_8';
...
function restoreSavedAnswers() {
    ...
    updateProgress();
            ...
            correctAnswers[1] = 'Elsinore';
            correctAnswers[2] = '077896245';
            correctAnswers[3] = 'waiter';
            correctAnswers[4] = 'baseball';
            correctAnswers[5] = 'October';
            correctAnswers[6] = 'beach';
            correctAnswers[7] = 'diving';
            correctAnswers[8] = 'Saturday';
            correctAnswers[9] = 'six|6';
            correctAnswers[10] = 'radio';
            correctAnswers[11] = 'A';
            correctAnswers[12] = 'A';
            correctAnswers[13] = 'C';
            correctAnswers[14] = 'B';
            correctAnswers[15] = 'C';
            correctAnswers[16] = 'A';
            correctAnswers[17] = 'B,C';
            correctAnswers[18] = 'B,C';
            correctAnswers[19] = 'A,E';
            correctAnswers[20] = 'A,E';
            correctAnswers[21] = 'B';
            correctAnswers[22] = 'A';
            correctAnswers[23] = 'A';
            correctAnswers[24] = 'B';
            ...
            correctAnswers[29] = 'A';
            correctAnswers[30] = 'F';
            correctAnswers[31] = 'sharks';
            correctAnswers[32] = 'cost';
            correctAnswers[33] = 'catch';
            correctAnswers[34] = 'ocean';
            correctAnswers[35] = 'helicopter';
            correctAnswers[36] = 'rocks';
            correctAnswers[37] = 'paint';
            correctAnswers[38] = 'diagram';
            correctAnswers[39] = 'zoos';
            correctAnswers[40] = 'public';

            // Test Section Data
            const testData = [
                {
                    title: "SECTION 1",
                    instructions: "Questions 1-10: Fearnley Sports Center Lifeguard Application Form",
                    description: "Complete the form below. NO MORE THAN TWO WORDS AND/OR A NUMBER.",
                    questionRange: "1-10"
                },
                {
                    title: "SECTION 2",
                    instructions: "Questions 11-20: Becoming a Millionaire",
                    description: "Q11-16 multiple choice, Q17-20 combined multiple choice.",
                    questionRange: "11-20"
                },
                {
                    title: "SECTION 3",
                    instructions: "Questions 21-30: Performance Arts Course Feedback",
                    description: "Q21-26 multiple choice and Q27-30 drag-and-drop.",
                    questionRange: "21-30"
                },
                {
                    title: "SECTION 4",
                    instructions: "Questions 31-40: Sea Lion Tracking Study (Western Australia)",
            ...
            function updateLimitedCheckboxGroup(groupName, qIds, maxSelections) {
                const checked = Array.from(document.querySelectorAll(`input[name="${groupName}"]:checked`));
                if (checked.length > maxSelections) {
                    checked[checked.length - 1].checked = false;
                }
                updateCheckboxGroup(qIds, groupName);
            }
