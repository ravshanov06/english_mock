...
const TEST_STORAGE_ID = 'listening_test_36';
...
function restoreSavedAnswers() {
    ...
    updateProgress();
            ...
            const audioSequence = [
                "TEST 36 section 1.mp3",
                "TEST 36 section 2.mp3",
                "TEST 36 section 3.mp3",
                "TEST 36 section 4.mp3"
            ];
            ...
            // Listening Full 36 - "School Art Competition / Regional Park walks
            // and map / Music degree, practice and performance / Gastropods
            // (snails and slugs)".
            // Q21+22, Q23+24, Q25+26 are paired multi-select groups (Choose
            // TWO letters A-E). Each pair shares one combined alphabetically-
            // sorted two-letter answer (e.g. correctAnswers[21] = correctAnswers[22] = 'DE').
            correctAnswers[1] = 'animals';
            correctAnswers[2] = 'zoo';
            correctAnswers[3] = 'city';
            correctAnswers[4] = 'travel';
            correctAnswers[5] = '18 may|18th may|may 18|may 18th';
            correctAnswers[6] = 'library';
            correctAnswers[7] = 'leigh';
            correctAnswers[8] = '04076254633';
            correctAnswers[9] = 'magazine';
            correctAnswers[10] = 'dinner';
            correctAnswers[11] = 'D';
            correctAnswers[12] = 'G';
            correctAnswers[13] = 'A';
            correctAnswers[14] = 'F';
            ...
            correctAnswers[19] = 'C';
            correctAnswers[20] = 'I';
            correctAnswers[21] = 'CD';
            correctAnswers[22] = 'CD';
            correctAnswers[23] = 'CE';
            correctAnswers[24] = 'CE';
            correctAnswers[25] = 'AC';
            correctAnswers[26] = 'AC';
            correctAnswers[27] = 'B';
            correctAnswers[28] = 'E';
            correctAnswers[29] = 'D';
            correctAnswers[30] = 'A';
            correctAnswers[31] = 'sea';
            correctAnswers[32] = 'right';
            correctAnswers[33] = 'hair';
            correctAnswers[34] = 'worms';
            correctAnswers[35] = '1st century|first century';
            correctAnswers[36] = 'defences|defenses';
            correctAnswers[37] = 'dry';
            correctAnswers[38] = 'forests';
            correctAnswers[39] = 'ground';
            correctAnswers[40] = 'environment';
            ...
            const testData = [
                {
                    title: "SECTION 1",
                    instructions: "Questions 1-10: School Art Competition",
                    description: "Q1-4 complete the table (ONE WORD ONLY); Q5-10 complete the notes (ONE WORD AND/OR A NUMBER).",
                    questionRange: "1-10"
                },
                {
                    title: "SECTION 2",
                    instructions: "Questions 11-20: Recommended walks at the Regional Park",
                    description: "Q11-14 match recommended features; Q15-20 label the Regional Park map (A-J).",
                    questionRange: "11-20"
                },
                {
                    title: "SECTION 3",
                    instructions: "Questions 21-30: Music degree, practice and pieces",
                    description: "Q21-26 choose TWO letters per pair; Q27-30 match aspects of performance to comments.",
                    questionRange: "21-30"
                },
                {
                    title: "SECTION 4",
                    instructions: "Questions 31-40: Gastropods (snails and slugs)",
                    description: "Complete the notes. ONE WORD AND/OR A NUMBER for each answer.",
                    questionRange: "31-40"
                }
            ];
            const partRanges = [
            ...
            // Q15-20 use plain radio inputs in the Regional Park map table.
            const radioQuestionIds = [15, 16, 17, 18, 19, 20];
            // Q21+Q22, Q23+Q24, Q25+Q26 are three paired multi-select groups
            // ("choose TWO letters A-E"). Each pair shares one checkbox group;
            // both members end up with the same alphabetically-sorted combined
            // two-letter answer (e.g. 'DE').
            const multiSelectQuestionIds = [21, 22, 23, 24, 25, 26];
            const multiGroupMap = {
                21: 'q21_22',
                22: 'q21_22',
                23: 'q23_24',
            ...
            // Q11-14 = drag-drop A-G (recommended features for walks).
            // Q27-30 = drag-drop A-G (aspects of performance to student comments).
            const dropZoneQuestionIds = [11, 12, 13, 14, 27, 28, 29, 30];
            ...
            function findFeedbackContainer(questionId) {
                ...
                if (dropZoneQuestionIds.includes(questionId)) {
                    const zoneEl = document.querySelector(`.drop-zone[data-target="q${questionId}"]`);
                    return zoneEl && zoneEl.closest ? (zoneEl.closest('.drop-item') || zoneEl.closest('.flow-box') || zoneEl.closest('.flow-step')) : null;
                }
