...
const TEST_STORAGE_ID = 'listening_test_35';
...
function restoreSavedAnswers() {
    ...
    updateProgress();
            ...
            const audioSequence = [
                "TEST 35 section 1.mp3",
                "TEST 35 section 2.mp3",
                "TEST 35 section 3.mp3",
                "TEST 35 section 4.mp3"
            ];
            ...
            // Listening Full 35 - "Renting an apartment / Driving lessons /
            // Mosquito net (Edward, Olyset) / Earth-sheltered Housing".
            correctAnswers[1] = 'studio';
            correctAnswers[2] = 'laundry';
            correctAnswers[3] = 'harbour|harbor';
            correctAnswers[4] = 'balcony';
            correctAnswers[5] = 'gym';
            correctAnswers[6] = 'cinemas';
            correctAnswers[7] = 'parking';
            correctAnswers[8] = '580';
            correctAnswers[9] = 'electricity';
            correctAnswers[10] = '13|13th';
            correctAnswers[11] = 'E';
            correctAnswers[12] = 'I';
            correctAnswers[13] = 'C';
            correctAnswers[14] = 'B';
            ...
            correctAnswers[29] = 'A';
            correctAnswers[30] = 'F';
            correctAnswers[31] = 'low impact';
            correctAnswers[32] = 'alternative';
            correctAnswers[33] = 'life span|lifespan';
            correctAnswers[34] = 'traffic';
            correctAnswers[35] = 'ventilation';
            correctAnswers[36] = 'conservation';
            correctAnswers[37] = 'C';
            correctAnswers[38] = 'B';
            correctAnswers[39] = 'A';
            correctAnswers[40] = 'A';
            ...
            const testData = [
                {
                    title: "SECTION 1",
                    instructions: "Questions 1-10: Renting an apartment",
                    description: "Complete the notes. ONE WORD AND/OR A NUMBER for each answer.",
                    questionRange: "1-10"
                },
                {
                    title: "SECTION 2",
                    instructions: "Questions 11-20: Driving lessons",
                    description: "Q11-16 label the flow chart (A-I); Q17-20 multiple choice.",
                    questionRange: "11-20"
                },
                {
                    title: "SECTION 3",
                    instructions: "Questions 21-30: Product development presentation: mosquito net",
                    description: "Q21-25 multiple choice; Q26-30 label the seminar flow chart (A-G).",
                    questionRange: "21-30"
                },
                {
                    title: "SECTION 4",
                    instructions: "Questions 31-40: Earth-sheltered Housing",
                    description: "Q31-36 sentence completion (NO MORE THAN TWO WORDS); Q37-40 match UK projects.",
                    questionRange: "31-40"
                }
            ];
            const partRanges = [
            ...
            // Q17-20 (theory/practical course MCQ) and Q21-25 (mosquito net MCQ)
            // and Q37-40 (Mole Manor / Hockerton matching A/B/C) are radio-style
            // single-choice answers.
            const radioQuestionIds = [17, 18, 19, 20, 21, 22, 23, 24, 25, 37, 38, 39, 40];
            const multiSelectQuestionIds = [];
            const multiGroupMap = {};
            const multiSelectSettings = {};
            // Q11-16 are drag-drop letter labels for the Driving lessons flow
            // chart (A-I). Q26-30 are drag-drop labels for the seminar flow
            // chart (A-G).
            const dropZoneQuestionIds = [11, 12, 13, 14, 15, 16, 26, 27, 28, 29, 30];
