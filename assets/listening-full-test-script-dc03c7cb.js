            ...
            const TEST_STORAGE_ID = 'listening_test_6';
...
const REDO_QUERY = SEARCH_PARAMS.get('redo') === '1';
            ...
            function restoreSavedAnswers() {
                ...
                Object.keys(answers).forEach((key) => {
                    ...
                    if (qId === 24 || qId === 25) {
                        const selected = String(value).toUpperCase().split('');
                        document.querySelectorAll('input[name="q24_25"]').forEach((input) => {
                            input.checked = selected.includes(String(input.value || '').toUpperCase());
                        });
                        return;
                    }
            ...
            correctAnswers[1] = 'october 15|october 15th|15 october|15th october';
            correctAnswers[2] = 'hotel';
            correctAnswers[3] = '175';
            correctAnswers[4] = 'sailing';
            correctAnswers[5] = 'class';
            correctAnswers[6] = 'golf';
            correctAnswers[7] = 'fishing';
            correctAnswers[8] = 'caravan';
            correctAnswers[9] = 'massage';
            correctAnswers[10] = 'menu';
            correctAnswers[11] = 'H';
            correctAnswers[12] = 'A';
            correctAnswers[13] = 'G';
            correctAnswers[14] = 'C';
            ...
            correctAnswers[19] = 'H';
            correctAnswers[20] = 'B';
            correctAnswers[21] = 'weather';
            correctAnswers[22] = 'electricity';
            correctAnswers[23] = 'explode';
            correctAnswers[24] = 'C';
            correctAnswers[25] = 'E';
            correctAnswers[26] = 'A';
            correctAnswers[27] = 'B';
            ...
            correctAnswers[29] = 'A';
            correctAnswers[30] = 'B';
            correctAnswers[31] = 'gender';
            correctAnswers[32] = 'attitude';
            correctAnswers[33] = 'culture';
            correctAnswers[34] = 'industry';
            correctAnswers[35] = 'size';
            correctAnswers[36] = 'efficient';
            correctAnswers[37] = 'external';
            correctAnswers[38] = 'larger';
            correctAnswers[39] = 'benefits';
            correctAnswers[40] = 'dismiss';

            // Test Section Data
            const testData = [
                {
                    title: "SECTION 1",
                    instructions: "Questions 1-10: Beach Heads Travel",
                    description: "Complete the form below.",
                    questionRange: "1-10"
                },
                {
                    title: "SECTION 2",
                    instructions: "Questions 11-20: City Cycle / Bicycle Centre Plan",
                    description: "Flow-chart and map labeling.",
                    questionRange: "11-20"
                },
                {
                    title: "SECTION 3",
                    instructions: "Questions 21-30: Renewable energy survey",
                    description: "Notes, two-answer selection, and multiple choice.",
                    questionRange: "21-30"
                },
                {
                    title: "SECTION 4",
                    instructions: "Questions 31-40: Absence from work",
            ...
            const radioQuestionIds = [16, 17, 18, 19, 20, 26, 27, 28, 29, 30];
            const multiSelectQuestionIds = [24, 25];
            const dropZoneQuestionIds = [11, 12, 13, 14, 15];
            ...
            multiGroupMap[24] = 'q24_25';
            multiGroupMap[25] = 'q24_25';
            multiSelectSettings.q24_25 = {
                type: 'perLetter',
                answers: {
                    24: 'A',
                    25: 'E'
