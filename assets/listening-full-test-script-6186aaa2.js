...
const TEST_STORAGE_ID = 'listening_test_14';
...
function restoreDropZoneAnswer(questionId, answerValue) {
    ...
    const searchScope = layout || document;
    const item = Array.from(searchScope.querySelectorAll('.drag-item')).find((node) =>
...
function restoreSavedAnswers() {
    ...
    Object.keys(answers).forEach((key) => {
        ...
        const groupName = multiGroupMap && multiGroupMap[qId];
        if (groupName) {
            const selected = String(value).split(',').map((entry) => entry.trim().toUpperCase()).filter(Boolean);
            document.querySelectorAll(`input[name="${groupName}"][type="checkbox"]`).forEach((node) => {
    ...
    updateProgress();
            ...
            correctAnswers[1] = 'southeast|south east|south-east';
            correctAnswers[2] = 'washing machine';
            correctAnswers[3] = '15th may|15 may|may 15th|may 15|15/05|15/5|15.05|15.5';
            correctAnswers[4] = 'employer';
            correctAnswers[5] = '675|£675|gbp 675';
            correctAnswers[6] = 'translator';
            correctAnswers[7] = 'bank statement';
            correctAnswers[8] = 'ainsworth';
            correctAnswers[9] = 'telephone|phone';
            correctAnswers[10] = 'bus stop';
            correctAnswers[11] = 'A';
            correctAnswers[12] = 'B';
            correctAnswers[13] = 'B';
            correctAnswers[14] = 'E';
            ...
            correctAnswers[29] = 'E';
            correctAnswers[30] = 'F';
            correctAnswers[31] = 'confidence';
            correctAnswers[32] = 'risks';
            correctAnswers[33] = 'listening';
            correctAnswers[34] = 'responsible';
            correctAnswers[35] = 'therapy';
            correctAnswers[36] = 'safe';
            correctAnswers[37] = 'morality';
            correctAnswers[38] = 'participation';
            correctAnswers[39] = 'remember';
            correctAnswers[40] = 'problems';
            ...
            const testData = [
                {
                    title: "SECTION 1",
                    instructions: "Questions 1-10: Accommodation request",
                    description: "Complete the notes below. NO MORE THAN TWO WORDS AND/OR A NUMBER.",
                    questionRange: "1-10"
                },
                {
                    title: "SECTION 2",
                    instructions: "Questions 11-20: Green Island Nature Park",
                    description: "Q11-12 multiple choice, Q13-14 choose two letters, and Q15-20 activity rules.",
                    questionRange: "11-20"
                },
                {
                    title: "SECTION 3",
                    instructions: "Questions 21-30: Presentation comments",
                    description: "Q21-24 multiple choice and Q25-30 matching comments.",
                    questionRange: "21-30"
                },
                {
                    title: "SECTION 4",
                    instructions: "Questions 31-40: Effects of Drama Activities on Children",
            ...
            const radioQuestionIds = [11, 12, 21, 22, 23, 24];
            const multiSelectQuestionIds = [13, 14];
            const dropZoneQuestionIds = [15, 16, 17, 18, 19, 20, 25, 26, 27, 28, 29, 30];

            const multiGroupMap = { 13: "q13_14", 14: "q13_14" };
