...
const TEST_STORAGE_ID = 'listening_test_5';
...
function restoreSavedAnswers() {
    ...
    updateProgress();
            ...
            correctAnswers[1] = 'jacket';
            correctAnswers[2] = 'desert';
            correctAnswers[3] = 'space museum|museum';
            correctAnswers[4] = 'golf';
            correctAnswers[5] = 'fearnleigh';
            correctAnswers[6] = '1901';
            correctAnswers[7] = 'fireworks';
            correctAnswers[8] = '9286352271';
            correctAnswers[9] = 'helicopter';
            correctAnswers[10] = 'sun cream|suncream';
            correctAnswers[11] = 'I';
            correctAnswers[12] = 'H';
            correctAnswers[13] = 'D';
            correctAnswers[14] = 'G';
            ...
            correctAnswers[24] = 'B';
            correctAnswers[25] = 'A';
            correctAnswers[26] = 'subtopics';
            correctAnswers[27] = 'reports|report';
            correctAnswers[28] = 'examples|example';
            correctAnswers[29] = 'ideas|idea';
            correctAnswers[30] = 'reading';
            correctAnswers[31] = 'trade';
            correctAnswers[32] = 'science';
            correctAnswers[33] = 'numbers|number';
            correctAnswers[34] = 'songs|song';
            correctAnswers[35] = 'negative';
            correctAnswers[36] = 'letter';
            correctAnswers[37] = 'picture';
            correctAnswers[38] = 'hospital';
            correctAnswers[39] = 'emotions|emotion';
            correctAnswers[40] = 'writers|writer';

            // Test Section Data
            const testData = [
                {
                    title: "SECTION 1",
                    instructions: "Questions 1-10: Arizona - travel advice",
                    description: "Complete the form below.",
                    questionRange: "1-10"
                },
                {
                    title: "SECTION 2",
                    instructions: "Questions 11-20: City Bookshop",
                    description: "Map labeling and matching.",
                    questionRange: "11-20"
                },
                {
                    title: "SECTION 3",
                    instructions: "Questions 21-30: Academic essays",
                    description: "Choose answers and complete sentences.",
                    questionRange: "21-30"
                },
                {
                    title: "SECTION 4",
                    instructions: "Questions 31-40: Invenitng a Universal Language",
            ...
            const radioQuestionIds = [11, 12, 13, 14, 15, 16, 21, 22, 23, 24, 25];
            const multiSelectQuestionIds = [];
            const dropZoneQuestionIds = [17, 18, 19, 20];
            ...
            function findFeedbackContainer(questionId) {
                ...
                if (multiSelectQuestionIds.includes(questionId)) {
                    return document.querySelector(`[data-multi-target="q${questionId}"]`);
                }
