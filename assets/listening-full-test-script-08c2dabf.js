...
const TEST_STORAGE_ID = 'listening_test_20';
...
function restoreDropZoneAnswer(questionId, answerValue) {
    ...
    const scopedOptionPrefix = questionId >= 25 ? 'opt25' : (questionId >= 11 ? 'opt11' : '');
...
function restoreSavedAnswers() {
    ...
    Object.keys(answers).forEach((key) => {
        ...
        const groupName = multiGroupMap[qId];
        if (groupName) {
            const groupCheckboxes = document.querySelectorAll(`input[name="${groupName}"][type="checkbox"]`);
            if (groupCheckboxes.length) {
                const selected = String(value).split(',').map((entry) => entry.trim().toUpperCase()).filter(Boolean);
                groupCheckboxes.forEach((node) => {
    ...
    updateProgress();
            ...
            correctAnswers[1] = 'WX717435T';
            correctAnswers[2] = '30 april 1972|30th april 1972|april 30 1972|april 30th 1972|30 april|30th april|april 30|april 30th|30/04/1972|30/4/1972|30.04.1972|30-04-1972';
            correctAnswers[3] = 'bike';
            correctAnswers[4] = 'compucan';
            correctAnswers[5] = '560|\u00a3560|gbp 560';
            correctAnswers[6] = 'keyboard';
            correctAnswers[7] = 'family';
            correctAnswers[8] = 'train';
            correctAnswers[9] = 'case';
            correctAnswers[10] = 'report';
            correctAnswers[11] = 'A';
            correctAnswers[12] = 'C';
            correctAnswers[13] = 'G';
            correctAnswers[14] = 'D';
            ...
            correctAnswers[29] = 'H';
            correctAnswers[30] = 'G';
            correctAnswers[31] = 'coconut';
            correctAnswers[32] = 'stones';
            correctAnswers[33] = 'belt';
            correctAnswers[34] = 'sour';
            correctAnswers[35] = 'biscuits';
            correctAnswers[36] = 'fertiliser|fertilizer';
            correctAnswers[37] = 'celebration';
            correctAnswers[38] = 'harp';
            correctAnswers[39] = 'ropes|rope';
            correctAnswers[40] = 'houses';
            ...
            const testData = [
                {
                    title: "PART 1",
                    instructions: "Questions 1-10: Corton Insurance claim form",
                    description: "Complete the form below. ONE WORD AND/OR A NUMBER.",
                    questionRange: "1-10"
                },
                {
                    title: "PART 2",
                    instructions: "Questions 11-20: Forest Lake Campsite",
                    description: "Q11-16 map matching and Q17-20 two-answer checkbox questions.",
                    questionRange: "11-20"
                },
                {
                    title: "PART 3",
                    instructions: "Questions 21-30: Dolphin presentation",
                    description: "Q21-24 multiple choice and Q25-30 matching.",
                    questionRange: "21-30"
                },
                {
                    title: "PART 4",
                    instructions: "Questions 31-40: The Lontar Palm",
            ...
            const radioQuestionIds = [11, 12, 13, 14, 15, 16, 21, 22, 23, 24];
            const multiSelectQuestionIds = [17, 18, 19, 20];
            ...
            const multiSelectSettings = {
                q17_18: { type: 'perLetter', answers: { 17: 'A', 18: 'E' } },
                q19_20: { type: 'perLetter', answers: { 19: 'B', 20: 'D' } }
            };
            ...
            function focusQuestion(qNum) {
                const groupName = multiGroupMap[qNum];
                const el = document.getElementById(`q${qNum}`) || document.querySelector(`input[name="q${qNum}"]`) || document.querySelector(`input[name="${groupName}"]`) || document.querySelector(`.drop-zone[data-target="q${qNum}"]`);
                if (el) {
                    el.focus();
