    ...
    // Correct Answers (Residence Survey)
    const correctAnswers = {
        1: ["salesman"],
        2: ["9 years", "nine years"],
        3: ["spring park"],
        4: ["apartment"],
        5: ["train"],
        6: ["once a month"],
    ...
    const testData = [
        {
            title: "SECTION 1",
            instructions: "Complete the notes below. Questions 1-5: up to two words/a number; Questions 6-10: up to three words/a number.",
            description: "Listen for the Residence Survey information and record the details.",
            questionRange: "1-10"
        }
    ];
