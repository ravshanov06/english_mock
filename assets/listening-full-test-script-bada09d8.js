...
const TEST_STORAGE_ID = 'listening_test_29';
...
function restoreSavedAnswers() {
    ...
    updateProgress();
            ...
            const audioSequence = [
                "TEST 29 SECTION 1.mp3",
                "TEST 29 SECTION 2.mp3",
                "TEST 29 SECTION 3.mp3",
                "TEST 29 SECTION 4.mp3"
            ];
            ...
            correctAnswers[5] = 'A';
            correctAnswers[6] = 'C';
            correctAnswers[7] = 'deposit';
            correctAnswers[8] = 'invitations';
            correctAnswers[9] = 'transport';
            correctAnswers[10] = 'presents';
            correctAnswers[11] = 'Lead';
            correctAnswers[12] = 'Sheet';
            correctAnswers[13] = 'House';
            correctAnswers[14] = 'horse hair';
            correctAnswers[15] = 'rubber';
            correctAnswers[16] = 'stopwatch|stop watch';
            correctAnswers[17] = 'B';
            correctAnswers[18] = 'C';
            correctAnswers[19] = 'B';
            correctAnswers[20] = 'C';
            ...
            correctAnswers[29] = 'C';
            correctAnswers[30] = 'B';
            correctAnswers[31] = 'confusion';
            correctAnswers[32] = 'generations';
            correctAnswers[33] = 'environment';
            correctAnswers[34] = 'rights';
            correctAnswers[35] = 'living';
            correctAnswers[36] = 'time';
            correctAnswers[37] = 'accept';
            correctAnswers[38] = 'roads';
            correctAnswers[39] = 'corn';
            correctAnswers[40] = 'diet';
            ...
            const testData = [
                {
                    title: "SECTION 1",
                    instructions: "Questions 1-10: Birthday party arrangements",
                    description: "Q1-6 matching hotels and Q7-10 note completion.",
                    questionRange: "1-10"
                },
                {
                    title: "SECTION 2",
                    instructions: "Questions 11-20: The game of curling",
                    description: "Q11-16 sentence completion and Q17-20 multiple choice.",
                    questionRange: "11-20"
                },
                {
                    title: "SECTION 3",
                    instructions: "Questions 21-30: Using scientific techniques to investigate works of art",
                    description: "Q21-24 multiple choice and Q25-30 flow-chart drag-drop.",
                    questionRange: "21-30"
                },
                {
                    title: "SECTION 4",
                    instructions: "Questions 31-40: Sustainability",
            ...
            const radioQuestionIds = [17, 18, 19, 20, 21, 22, 23, 24];
            const multiSelectQuestionIds = [];
            const dropZoneQuestionIds = [1, 2, 3, 4, 5, 6, 25, 26, 27, 28, 29, 30];
