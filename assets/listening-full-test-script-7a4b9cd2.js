...
const TEST_STORAGE_ID = 'listening_test_34';
...
function restoreSavedAnswers() {
    ...
    updateProgress();
            ...
            const audioSequence = [
                "TEST 34 section 1.mp3",
                "TEST 34 section 2.mp3",
                "TEST 34 section 3.mp3",
                "TEST 34 section 4.mp3"
            ];
            ...
            // Listening Full 34 - "Holiday rental / Bridge to Brisbane Fun Run /
            // Farmers' attitudes / Aboriginal Textile Design".
            correctAnswers[1] = 'september 14|september 14th|14 september|14th september';
            correctAnswers[2] = '835';
            correctAnswers[3] = 'school';
            correctAnswers[4] = 'deck';
            correctAnswers[5] = 'river';
            correctAnswers[6] = 'towels';
            correctAnswers[7] = 'garage';
            correctAnswers[8] = 'chinese';
            correctAnswers[9] = '200';
            correctAnswers[10] = 'july';
            correctAnswers[11] = 'A';
            correctAnswers[12] = 'B';
            correctAnswers[13] = 'A';
            correctAnswers[14] = 'B';
            ...
            correctAnswers[29] = 'D';
            correctAnswers[30] = 'B';
            correctAnswers[31] = 'wool';
            correctAnswers[32] = 'bird';
            correctAnswers[33] = 'rain';
            correctAnswers[34] = 'desert';
            correctAnswers[35] = 'prison';
            correctAnswers[36] = 'clothing';
            correctAnswers[37] = 'family';
            correctAnswers[38] = 'rainbow';
            correctAnswers[39] = 'snake';
            correctAnswers[40] = 'carpet';
            ...
            const testData = [
                {
                    title: "SECTION 1",
                    instructions: "Questions 1-10: Holiday rental",
                    description: "Complete the notes. ONE WORD AND/OR A NUMBER for each answer.",
                    questionRange: "1-10"
                },
                {
                    title: "SECTION 2",
                    instructions: "Questions 11-20: Bridge to Brisbane Fun Run",
                    description: "Q11-14 multiple choice; Q15-20 label the map.",
                    questionRange: "11-20"
                },
                {
                    title: "SECTION 3",
                    instructions: "Questions 21-30: Farmers' attitudes to new developments in agriculture",
                    description: "Q21-26 multiple choice; Q27-30 match the books to opinions.",
                    questionRange: "21-30"
                },
                {
                    title: "SECTION 4",
                    instructions: "Questions 31-40: Aboriginal Textile Design",
            ...
            // Q11-14 are A/B/C single-choice radios. Q15-20 are A-I map-label
            // radios. Q21-26 are A/B/C single-choice radios for the Farmers
            // discussion.
            ...
            // Q27-30 are drag-drop letter matching for Books в†’ Opinions.
            const dropZoneQuestionIds = [27, 28, 29, 30];
