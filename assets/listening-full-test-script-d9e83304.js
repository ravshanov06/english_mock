...
const TEST_STORAGE_ID = 'listening_test_33';
...
function restoreSavedAnswers() {
    ...
    updateProgress();
            ...
            const audioSequence = [
                "TEST 33 section 1.mp3",
                "TEST 33 section 2.mp3",
                "TEST 33 section 3.mp3",
                "TEST 33 section 4.mp3"
            ];
            ...
            // Listening Full 33 - "Getting a job with an airline" pack.
            // Q11/Q12 and Q13/Q14 are paired multi-select groups: both members of
            // each pair share the same alphabetically-sorted two-letter combined
            // answer (e.g. Q11 = Q12 = 'DE' meaning the user must tick D and E).
            correctAnswers[1] = 'money';
            correctAnswers[2] = '168';
            correctAnswers[3] = 'maths';
            correctAnswers[4] = 'language';
            correctAnswers[5] = 'swim';
            correctAnswers[6] = 'illness';
            correctAnswers[7] = 'cultures';
            correctAnswers[8] = 'EURONTAS';
            correctAnswers[9] = 'team';
            correctAnswers[10] = 'uniform';
            correctAnswers[11] = 'DE';
            correctAnswers[12] = 'DE';
            correctAnswers[13] = 'CD';
            correctAnswers[14] = 'CD';
            correctAnswers[15] = 'B';
            correctAnswers[16] = 'B';
            correctAnswers[17] = 'A';
            correctAnswers[18] = 'C';
            ...
            correctAnswers[29] = 'A';
            correctAnswers[30] = 'A';
            correctAnswers[31] = 'engineering';
            correctAnswers[32] = 'printed';
            correctAnswers[33] = 'global market';
            correctAnswers[34] = 'documentation';
            correctAnswers[35] = 'traditional';
            correctAnswers[36] = 'tutorials';
            correctAnswers[37] = 'reflective';
            correctAnswers[38] = 'business plan';
            correctAnswers[39] = 'journalism';
            correctAnswers[40] = 'interview';
            ...
            const testData = [
                {
                    title: "SECTION 1",
                    instructions: "Questions 1-10: Getting a job with an airline",
                    description: "Complete the notes. ONE WORD AND/OR A NUMBER for each answer.",
                    questionRange: "1-10"
                },
                {
                    title: "SECTION 2",
                    instructions: "Questions 11-20: Marie's hospitality scholarship",
                    description: "Q11-12 and Q13-14 choose TWO letters; Q15-20 multiple choice.",
                    questionRange: "11-20"
                },
                {
                    title: "SECTION 3",
                    instructions: "Questions 21-30: Education House",
                    description: "Q21-26 label the diagram; Q27-30 multiple choice.",
                    questionRange: "21-30"
                },
                {
                    title: "SECTION 4",
                    instructions: "Questions 31-40: Textiles with Business Studies",
                    description: "Complete the notes. NO MORE THAN TWO WORDS for each answer.",
                    questionRange: "31-40"
                }
            ];
            const partRanges = [
            ...
            // Q15-20 and Q27-30 are A/B/C single-choice radios.
            const radioQuestionIds = [15, 16, 17, 18, 19, 20, 27, 28, 29, 30];
            // Q11+Q12 ("choose TWO letters A-E") and Q13+Q14 ("choose TWO letters
            // A-E") are paired multi-select groups. Each pair shares one checkbox
            // group; both Q IDs end up with the same alphabetically-sorted
            // two-letter combined answer (e.g. 'BD').
            const multiSelectQuestionIds = [11, 12, 13, 14];
            const multiGroupMap = {
                11: 'q11_12',
                12: 'q11_12',
                13: 'q13_14',
            ...
            // Q21-26 are drag-drop letter labels for the Education House diagram.
            const dropZoneQuestionIds = [21, 22, 23, 24, 25, 26];
