...
const TEST_STORAGE_ID = 'listening_test_17';
...
function restoreDropZoneAnswer(questionId, answerValue) {
    ...
    const scopedOptionPrefix = questionId >= 25 ? 'opt25' : (questionId >= 17 ? 'opt17' : '');
...
function restoreSavedAnswers() {
    ...
    updateProgress();
            ...
            correctAnswers[1] = '30th march 1988|30 march 1988|30 march, 1988|march 30th 1988|march 30 1988|march 30th, 1988|march 30, 1988|30/03/1988|30/3/1988|30.03.1988|30.3.1988|30-03-1988|30-3-1988';
            correctAnswers[2] = '0903775115|0903 775 115|0903-775-115|090 377 5115';
            ...
            correctAnswers[10] = 'internet cafe|internet cafes|internet-cafe';
            correctAnswers[11] = 'B';
            correctAnswers[12] = 'A';
            correctAnswers[13] = 'C';
            correctAnswers[14] = 'A';
            ...
            correctAnswers[29] = 'E';
            correctAnswers[30] = 'F';
            correctAnswers[31] = 'pottery';
            correctAnswers[32] = 'castle';
            correctAnswers[33] = 'survey';
            correctAnswers[34] = 'market';
            correctAnswers[35] = 'silver coins';
            correctAnswers[36] = 'textile';
            correctAnswers[37] = 'water';
            correctAnswers[38] = 'bridge';
            correctAnswers[39] = 'lions|lion';
            correctAnswers[40] = 'emperor';
            ...
            const testData = [
                ...
                {
                    title: "SECTION 2",
                    instructions: "Questions 11-20: The Middletown Urban Farming Scheme",
                    description: "Q11-16 multiple choice and Q17-20 matching.",
                    questionRange: "11-20"
                },
                {
                    title: "SECTION 3",
                    instructions: "Questions 21-30: The Just-in-Time Supply System",
                    description: "Q21-24 multiple choice and Q25-30 matching.",
                    questionRange: "21-30"
                },
                {
                    title: "SECTION 4",
                    instructions: "Questions 31-40: The archaeological site of Trimera",
                    description: "Q31-36 notes and Q37-40 table completion.",
                    questionRange: "31-40"
                }
            ];
            const partRanges = [
            ...
            const dropZoneQuestionIds = [17, 18, 19, 20, 25, 26, 27, 28, 29, 30];
