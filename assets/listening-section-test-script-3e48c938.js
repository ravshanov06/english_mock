    ...
    // Correct Answers (Student Accommodation)
    const correctAnswers = {
        1: ["3834"],
        2: ["holidays"],
        3: ["home welcome", "homewelcome"],
        4: ["flexible"],
        5: ["studio"],
        6: ["48"],
        7: ["water"],
        8: ["transportation"],
        9: ["(a) deposit", "a deposit", "deposit"],
        10: ["references"]
    };
    ...
    const testData = [
        {
            ...
            description: "Listen for the Student Accommodation details and complete the table.",
            questionRange: "1-10"
        }
    ];
