        ...
        const TEST_STORAGE_ID = 'reading_reading_passage_2s_passage_2_35';
        const TEST_LABEL = 'Passage 2.35';
...
function normalizeSummaryGroups() {
    document.querySelectorAll('.question-group').forEach(group => {
        ...
        const groupedChoiceConfigs = [
            { name: 'q23_24_choice', qStart: 23, qEnd: 24, reviewId: 'q23-24-review' },
            { name: 'q25_26_choice', qStart: 25, qEnd: 26, reviewId: 'q25-26-review' },
        ];
        ...
        setupPairedMultiSelect('q21_22_choice', 'q21', 'q22');
        setupPairedMultiSelect('q23_24_choice', 'q23', 'q24');
        setupPairedMultiSelect('q25_26_choice', 'q25', 'q26');
