...
const TEST_STORAGE_ID = 'listening_test_27';
...
function restoreDropZoneAnswer(questionId, answerValue) {
    ...
    const answerText = String(answerValue).toUpperCase();
    const group = zone.closest('.matching-layout') || document;
    const candidates = Array.from(group.querySelectorAll('.drag-item')).concat(Array.from(document.querySelectorAll('.drag-item')));
    const item = candidates.find((node) =>
        (node.dataset.answer || node.dataset.option || '').toUpperCase() === answerText && node.dataset.used !== 'true'
    );
    if (!item) return;
...
function restoreSavedAnswers() {
    ...
    updateProgress();
            ...
            const audioSequence = [
                "TEST 27 section 1.mp3",
                "TEST 27 section 2.mp3",
                "TEST 27 section 3.mp3",
                "TEST 27 section 4.mp3"
            ];
            ...
            correctAnswers[1] = 'cash';
            correctAnswers[2] = 'museum';
            correctAnswers[3] = 'caravan';
            correctAnswers[4] = 'sailing';
            correctAnswers[5] = 'four days|4 days';
            correctAnswers[6] = 'white mountain';
            correctAnswers[7] = 'snowboarding';
            correctAnswers[8] = 'cakes|cake';
            correctAnswers[9] = 'car';
            correctAnswers[10] = 'map';
            correctAnswers[11] = 'G';
            correctAnswers[12] = 'E';
            correctAnswers[13] = 'A';
            correctAnswers[14] = 'F';
            ...
            correctAnswers[29] = 'B';
            correctAnswers[30] = 'C';
            correctAnswers[31] = 'costs|cost';
            correctAnswers[32] = 'store';
            correctAnswers[33] = 'powder';
            correctAnswers[34] = 'holes';
            correctAnswers[35] = 'electricity';
            correctAnswers[36] = 'starch';
            correctAnswers[37] = 'agriculture';
            correctAnswers[38] = 'factories';
            correctAnswers[39] = 'businesses';
            correctAnswers[40] = 'demand';
            ...
            const testData = [
                {
                    title: "SECTION 1",
                    instructions: "Questions 1-10: Holiday on Jackson Island",
                    description: "Complete the table and notes about Anna's holiday.",
                    questionRange: "1-10"
                },
                {
                    title: "SECTION 2",
                    instructions: "Questions 11-20: Grampic Arts Campus",
                    description: "Q11-15 map labelling and Q16-20 multiple choice.",
                    questionRange: "11-20"
                },
                {
                    title: "SECTION 3",
                    instructions: "Questions 21-30: Geography lesson plan",
                    description: "Q21-24 choose two letters and Q25-30 drag-and-drop flow chart.",
                    questionRange: "21-30"
                },
                {
                    title: "SECTION 4",
                    instructions: "Questions 31-40: Biomass fuel",
