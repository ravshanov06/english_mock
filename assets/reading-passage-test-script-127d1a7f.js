        ...
        const correctAnswers = {
            ...
            q21: "A",
            q22: "C",
            q23: "PARENTAL GUIDANCE|GUIDANCE",
            q24: "COMPASS",
            q25: "DAYTIME PREDATORS|PREDATORS",
            q26: "VISIBLE"
        };
        ...
        const TEST_STORAGE_ID = 'reading_reading_passage_2s_passage_2_24';
        const TEST_LABEL = 'Passage 2.24';
...
function normalizeSummaryGroups() {
    document.querySelectorAll('.question-group').forEach(group => {
        ...
        const groupedChoiceConfigs = [
            { name: 'q21_22_choice', qStart: 21, qEnd: 22, reviewId: 'q21-22-review' },
        ];
