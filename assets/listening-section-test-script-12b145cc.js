    ...
    // Test Section Data
	    const testData = [
	        {
	            title: "SECTION 2",
	            instructions: "Listen to the talk and answer Questions 11-20.",
	            description: "Sports Information for Parents and Cross Country Running Event.",
	            questionRange: "11-20"
	        }
	    ];
	        ...
	        for (const range of partRanges) {
	            for (let i = range.start; i <= range.end; i++) {
	                ...
	                detailedResults.push({
	                    questionId: i,
	                    userAnswer,
	                    correctAnswer: (correctValues[0] || '').toString().trim().toUpperCase(),
	                    isCorrect
	                });
	            }
	        }
